...
class Spiderweb
{
    constructor(center = vec3(0, 0, 0), numberOfRings = 12, numberOfSides = 13, radius_length = 6)
    {
        this.center = center;
        ...
        this.connect_with_springs(5000, 10, 1); //spring ks, spring kd, rest length modifier
    ...
    place_particles()
    {
        ...
        {
            let currentRing = 1;
            let segment_length = currentRing * this.radius_length / this.numberOfRings;
