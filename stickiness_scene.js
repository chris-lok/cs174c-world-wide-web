...
export
const Stickiness_Scene_Base = defs.Display_Scene_Base =
    class Stickiness_Scene_Base extends Component
    {                                          // **My_Demo_Base** is a Scene that can be added to any display canvas.
      ...
      init()
      {
        ...
        this.fall_particle.set_particle(2, vec3(0, 7, 0), vec3(0, 0, 0), vec3(0, 0, 0), vec3(0, 0, 0));
        this.sticky_module = new StickyModule(this.web.Simulation);
        this.sticky_module.add_projectile(this.fall_particle);
      }
...
export class Stickiness_Scene extends Stickiness_Scene_Base
{                                                    
  render_animation( caller )
  {                                          
    ...
    // Draw projectile that will fall into web
    this.shapes.ball.draw(caller, this.uniforms, Mat4.translation(this.fall_particle.pos[0], this.fall_particle.pos[1], this.fall_particle.pos[2]), { ...this.materials.plastic, color: blue });
  }
